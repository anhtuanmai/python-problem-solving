...
No further operation reduces the sum.
Thus, the final sum is 3 + 2 + 2 = 7.
...
No further operation reduces the sum.
Thus, the final sum is 2 + 2 + 2 + 3 = 9.
...
Hence, no operation can be performed.
The sum remains 7 + 5 + 9 = 21.
